...
xlsx_path = "/DVS/results/DVS_Component_Exchanges2.xlsx"
...
def collect_all_component_exchanges():
    ...
    try:
            ...
            try:
                ...
                for ce in java_object.getOwnedComponentExchanges():
                    ...
                    if source_port and target_port:
                        source_comp = source_port.get_java_object().eContainer()
                        target_comp = target_port.get_java_object().eContainer()
        ...
        # print(f"Found {sum(len(v) for d in exchanges.values() for v in d.values())} existing component exchanges")
        return exchanges
    except Exception as e:
        print(f"Error collecting existing component exchanges: {e}")
        return {}

def delete_unused_component_exchanges(imported_exchanges):
    ...
    try:
                    ...
                    try:
                        ...
                        if source_port and target_port:
                            ...
                            if source_comp and target_comp:
                                ...
                                print(f"Deleting component exchange: '{ce_name}' (ID: {exchange_id}) between '{source_comp_name}' and '{target_comp_name}'")
        ...
        print(f"Deleted {deleted_count} unused component exchanges")
...
try:
    ...
    # print("Collecting existing component exchanges...")
    existing_exchanges = collect_all_component_exchanges()
    ...
    print("\nDeleting unused component exchanges...")
    deleted_count = delete_unused_component_exchanges(imported_exchanges)
    print(f"Deleted {deleted_count} component exchanges that were not in the import file")
