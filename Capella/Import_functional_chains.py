...
# xlsx_path = "/In-Flight Entertainment System/results/In-Flight Entertainment System_Functional_Chains.xlsx"
...
try:
    ...
    for row in ws.iter_rows(min_row=2):
        ...
        if functional_chain_exists(fc_id):
            print(f"Functional chain with ID {fc_id} and name '{fc_name}' already exists. Skipping import.")
            continue
